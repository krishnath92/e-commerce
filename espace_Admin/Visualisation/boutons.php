...
<button style="margin-left: 40px; margin-bottom:10px"onclick="window.location.href='sousCat.php';" title='Voir les articles selon leur sous-catégorie (jogging...)'>Sous-catégorie</button>
<button style="margin-left: 40px; margin-bottom:10px"onclick="window.location.href='couleur.php';" title='Voir les articles selon leur couleur'>Couleur</button>
<button style="margin-left: 40px; margin-bottom:10px"onclick="window.location.href='stock.php';" title='Voir les articles selon leur quantité'>Stock</button>
